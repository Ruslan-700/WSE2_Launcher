...
void Class_Engine::FillMissingLocalizationKeys()
{
	...
	if (CurrentLanguage == "fr") {
#if defined WFAS
		LocalizedText.insert(std::pair("ui_play", u8"Jouer à M&B WFaS WSE2"));
		LocalizedText.insert(std::pair("ui_play_x64", u8"Jouer à M&B WFaS WSE2 x64"));
#else
		LocalizedText.insert(std::pair("ui_play", u8"Jouer à M&B Warband WSE2"));
		LocalizedText.insert(std::pair("ui_play_x64", u8"Jouer à M&B Warband WSE2 x64"));
#endif
		...
		LocalizedText.insert(std::pair("ui_ondemand_textures", u8"Charger les textures à la demande:"));
		LocalizedText.insert(std::pair("ui_update_wse2", u8"Mettre à jour WSE2"));
		LocalizedText.insert(std::pair("ui_install_wse2", u8"Installer WSE2"));
		LocalizedText.insert(std::pair("ui_version_is_up_to_date", u8"Votre version actuelle de WSE2 est à jour."));
