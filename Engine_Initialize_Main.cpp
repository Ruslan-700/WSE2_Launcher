...
void Class_Engine::Initialize_UI_Main()
{
	...
	ComboBoxModule->setPosition("60%", "30%");
	ComboBoxModule->setSize("40%", "5%");
	...
	ComboBoxModule->onItemSelect(&Class_Engine::UpdateModPreviewImage, this);
	...
	Button_Launch->setPosition("20%", "38%");
	Button_Launch->setSize("30%", "10%");
	...
	Button_Launch_Dedicated->setPosition("20%", "46%");
	Button_Launch_Dedicated->setSize("35%", "10%");
	...
	Button_Options->setPosition("20%", "54%");
	Button_Options->setSize("25%", "10%");
	...
	Picture_ModPreview->setPosition("64%", "59%");
	Picture_ModPreview->setSize("38%", "38%");
	...
	Button_Exit->setPosition("20%", "62%");
	Button_Exit->setSize("25%", "10%");
